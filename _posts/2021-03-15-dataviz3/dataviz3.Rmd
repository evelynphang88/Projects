...
![Critique](data3/Critique clarity.png)
### 3.2 Critic for Aesthetics and Suggestions for Improvement

![Critique](data3/Critique Aesthetics.png)
...
Evaluating the bar chart “Fatalities for Events” vs ‘Armed Confliect Events”= for the same period, we can see that  “Violence Against Civilians and Battles events caused the most fatalities. There was a sharp increase in both Events and Fatalities during the 5 quarters starting from 2016Q3. This is caused mainly by the events in Myanmar(for Battles) and Philippines ( for violence against civilians).
